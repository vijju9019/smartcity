...
export const WORKERS = [
  ...
  { id: 'w6', name: 'City Worker', dept: 'Maintenance', rating: 5.0, active: true, completed: 0 },
];
export const SEED_COMPLAINTS = [
  { id: 'c1', title: 'Burst water pipe near Block A', category: 'water', status: 'pending', priority: 'high', description: 'Water has been leaking since morning causing road damage.', location: 'Block A, Gate 2', worker_id: 'w6', created_at: Date.now() - 86400000 * 2, updated_at: Date.now() - 3600000, upvotes: 12, photo: null, lat: 12.9716, lng: 77.5946, ai_risk: 'High', ai_category: 'Water Infrastructure', resolution_notes: '' },
